#import "MintegralNetworkBannerCustomEvent.h"
...
@interface MintegralNetworkBannerCustomEvent() <MTGBannerAdViewDelegate>
...
@implementation MintegralNetworkBannerCustomEvent
@dynamic delegate;
@dynamic localExtras;
